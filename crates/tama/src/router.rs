...
use crate::api::backends::{
    ...
    register_backend, remove_backend, remove_backend_version, rename_backend, system_capabilities,
    update_backend, update_backend_default_args, update_backend_default_env, update_backend_source,
};
...
pub fn build_web_routes(
    ...
    let backend_routes = Router::new()
        ...
        .route("/tama/v1/backends/:name/rename", post(rename_backend))

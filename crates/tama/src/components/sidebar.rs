...
pub fn Sidebar() -> impl IntoView {
    ...
    view! {
        ...
        >
            ...
            <A href="/tama" attr:class="sidebar-header" on:click=move |_| mobile_open.set(false)>
                <span class="sidebar-header__logo">"🦙"</span>
                <span class="sidebar-header__text">"Tama"</span>
            </A>

            <nav class="sidebar-nav">
                <A href="/tama" attr:class="sidebar-item" attr:data-tooltip="Dashboard" on:click=move |_| mobile_open.set(false)>
                ...
                <A href="/tama/updates" attr:class="sidebar-item" attr:data-tooltip="Updates" on:click=move |_| mobile_open.set(false)>
                    <span class="sidebar-item__icon">"🔄"</span>
                ...
                <A href="/tama/downloads" attr:class="sidebar-item" attr:data-tooltip="Downloads" on:click=move |_| mobile_open.set(false)>
                    <span class="sidebar-item__icon">"📥"</span>
            ...
            <div class="sidebar-footer">
                <div class="sidebar-section" style="border-top:none;margin:0;padding:0;">
                    <A href="/tama/config" attr:class="sidebar-item" attr:data-tooltip="Config" on:click=move |_| mobile_open.set(false)>
                        <span class="sidebar-item__icon">"⚙️"</span>

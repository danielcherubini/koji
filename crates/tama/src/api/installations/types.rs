...
pub struct BackendListResponse {
    ...
    pub backends: Vec<InstallationCardDto>,
    pub custom: Vec<InstallationCardDto>,
    /// Docker-based backends (e.g. vLLM), kept separate from native `custom` backends.
    #[serde(default)]
    pub docker: Vec<InstallationCardDto>,
...
impl From<tama_core::installations::InstallationInfo> for InstallationInfoDto {
    fn from(info: tama_core::installations::InstallationInfo) -> Self {
        Self {
            name: info.name,
...
impl From<&tama_core::installations::InstallationSource> for InstallationSourceDto {
    fn from(source: &tama_core::installations::InstallationSource) -> Self {
        match source {
            tama_core::installations::InstallationSource::Prebuilt { version } => Self::Prebuilt {
...
pub struct RegisterBackendRequest {
    ...
    #[serde(default)]
    pub docker_config: Option<tama_core::installations::DockerConfig>,
}
...
impl From<tama_core::installations::InstallationInfo> for RegisterBackendResponse {
    fn from(info: tama_core::installations::InstallationInfo) -> Self {
        Self {
            name: info.name,
...
impl From<&tama_core::installations::DockerConfig> for DockerConfigDto {
    fn from(cfg: &tama_core::installations::DockerConfig) -> Self {
        Self {
...
impl From<&tama_core::installations::DockerVolume> for DockerVolumeDto {
    fn from(vol: &tama_core::installations::DockerVolume) -> Self {
        Self {
...
mod tests {
    ...
    // ── InstallationCardDto tests ────────────────────────────────────────────────

    #[test]
    fn test_default_uninstalled_sets_backend_name() {
        let card = InstallationCardDto::default_uninstalled(
            "llama_cpp",
            "llama.cpp",
    ...
    #[test]
    fn test_installation_card_dto_deserialize_without_backend_name() {
        ...
        let card: InstallationCardDto = serde_json::from_str(json).unwrap();

...
use crate::installations::installer::emit;
use crate::installations::installer::extract::find_backend_binary;
use crate::installations::installer::prebuilt::prepare_target_dir;
...
pub async fn install_from_source(
    ...
    {
        match crate::installations::check_latest_version(&options.backend_type, None, None).await {
            Ok(v) => {

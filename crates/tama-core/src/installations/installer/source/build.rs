...
use crate::installations::InstallOptions;
...
pub(crate) fn build_cmake_args(
    ...
    if matches!(
        ...
        crate::installations::types::InstallationType::IkLlama
    ) {
...
mod tests {
    use super::*;
    use crate::installations::installer::source::detect;
    use crate::installations::types::{InstallationSource, InstallationType};

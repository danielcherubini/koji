...
mod tests {
    ...
    #[test]
    fn test_flag_name_long_with_value() {
        assert_eq!(flag_name("--port 8080"), Some("--port"));
    }

    #[test]
    fn test_flag_name_long_inline_equals() {
        assert_eq!(flag_name("--port=8080"), Some("--port"));
    }

    #[test]
    fn test_flag_name_short_with_value() {
        assert_eq!(flag_name("-b 4096"), Some("-b"));
    }

    #[test]
    fn test_flag_name_boolean_long() {
        assert_eq!(flag_name("--mlock"), Some("--mlock"));
    }

    #[test]
    fn test_flag_name_negative_int_is_not_flag() {
        assert_eq!(flag_name("-1"), None);
    }

    #[test]
    fn test_flag_name_negative_float_is_not_flag() {
        assert_eq!(flag_name("-0.5"), None);
        assert_eq!(flag_name("-.5"), None);
    }

    #[test]
    fn test_flag_name_non_flag_value() {
        assert_eq!(flag_name("model.gguf"), None);
    }

    #[test]
    fn test_flag_name_empty_returns_none() {
        assert_eq!(flag_name(""), None);
    }

    #[test]
    fn test_flag_name_single_dash_is_not_flag() {
        // POSIX stdin placeholder
        assert_eq!(flag_name("-"), None);
    }

    #[test]
    fn test_flag_name_double_dash_is_not_flag() {
    ...
    #[test]
    fn test_split_simple_pair() {
        assert_eq!(split_arg_entry("-b 4096"), vec!["-b", "4096"]);
    }

    #[test]
    fn test_split_boolean_flag() {
        assert_eq!(split_arg_entry("--mlock"), vec!["--mlock"]);
    }

    #[test]
    fn test_split_quoted_value_with_space() {
        assert_eq!(
    ...
    #[test]
    fn test_split_unbalanced_quotes_falls_back() {
    ...
    #[test]
    fn test_flatten_preserves_quoted_paths() {
    ...
    #[test]
    fn test_merge_overrides_short_flag() {
        let base = vec![
            "-b 2048".to_string(),
            "-ub 512".to_string(),
            "--mlock".to_string(),
    ...
    #[test]
    fn test_merge_overrides_drop_all_base_occurrences() {
    ...
    #[test]
    fn test_merge_inline_equals_in_base_overridden_by_space_form() {
    ...
    #[test]
    fn test_merge_space_form_in_base_overridden_by_inline_equals() {
        let base = vec!["--port 8080".to_string()];
        let overrides = vec!["--port=9090".to_string()];
        let result = merge_args(&base, &overrides);
        assert_eq!(result, vec!["--port=9090".to_string()]);
    ...
    #[test]
    fn test_merge_boolean_flag_dedupes() {
    ...
    #[test]
    fn test_merge_disjoint_flags_concatenate() {
    ...
    #[test]
    fn test_merge_empty_overrides_returns_base_clone() {
        let base = vec!["-fa 1".to_string(), "-b 2048".to_string()];
    ...
    #[test]
    fn test_merge_empty_base_returns_overrides_clone() {
    ...
    #[test]
    fn test_merge_preserves_base_order_for_kept_entries() {
        let base = vec![
            "-fa 1".to_string(),
            "-b 2048".to_string(),
            "-ub 512".to_string(),
    ...
    #[test]
    fn test_merge_negative_value_not_treated_as_flag() {
    ...
    #[test]
    fn test_merge_long_flag_with_zero_value_overridden() {
    ...
    #[test]
    fn test_merge_overrides_with_internal_duplicates_preserved() {
    ...
    #[test]
    fn test_merge_non_flag_override_passes_through() {
    ...
    #[test]
    fn test_group_idempotent_on_already_grouped() {
    ...
    #[test]
    fn test_group_consecutive_boolean_flags() {
    ...
    #[test]
    fn test_group_mixed_boolean_and_pair() {
    ...
    #[test]
    fn test_group_negative_int_value() {
    ...
    #[test]
    fn test_group_negative_float_value() {
    ...
    #[test]
    fn test_group_path_with_spaces_quoted() {
    ...
    #[test]
    fn test_group_inline_equals_passes_through() {
        let flat = vec![
            "--port=8080".to_string(),
            "-fa".to_string(),
            "1".to_string(),
    ...
    #[test]
    fn test_group_orphan_value_passes_through() {
    ...
    #[test]
    fn test_group_empty_input_no_change() {
    ...
    #[test]
    fn test_group_user_real_world_example() {
    ...
    #[test]
    fn test_group_long_flag_with_zero_value() {
    ...
    #[test]
    fn test_group_long_flag_with_zero_value_followed_by_boolean() {
    ...
    #[test]
    fn test_group_inline_equals_flag_not_joined() {

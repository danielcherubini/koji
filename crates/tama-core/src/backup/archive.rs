...
"#;
        ...
        conn.execute(
            "INSERT INTO backend_installations (name, backend_type, version, path, installed_at, gpu_variant, source, is_active) VALUES ('llama_cpp', 'llama_cpp', 'v1.0', '/tmp/llama', 1234567890, 'cpu', 'prebuilt', 1);",
            [],

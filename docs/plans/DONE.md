...
|------|-------------|---------------------|
| [DB Access Consolidation](plan-160-db-access-consolidation.md) | Repository as single API-layer access point — absorb model writes, collapse DTO/Record duplication, seal escape hatches + ApiKeyStore, share one Repository via WebState, amend ADR-0017 | #161 ✅ COMPLETED | [`bf3292e0`](../../commit/bf3292e0), [`5261206c`](../../commit/5261206c), [`de3319de`](../../commit/de3319de), [`83bb28db`](../../commit/83bb28db), [`85bdee8b`](../../commit/85bdee8b), [`d8feafca`](../../commit/d8feafca) |

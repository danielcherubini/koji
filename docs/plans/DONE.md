...
|------|-------------|-----|---------------------|
| [Benchmarks Frontend Refactor](plan-182-benchmarks-frontend-refactor.md) | Extract LlamaBenchForm, shared ModelQuantSelect/BackendSelect/submit helper, hoisted tab state, type dedup, dead code removal, utils tests (~500 lines dedup) | — ✅ COMPLETED (merged to stage) | [`975a144c`](../../commit/975a144c), [`aaf6d39b`](../../commit/aaf6d39b), [`8c5b29b6`](../../commit/8c5b29b6), [`96fef5e1`](../../commit/96fef5e1), [`26b19023`](../../commit/26b19023), [`c820fe2d`](../../commit/c820fe2d), [`c7dc6416`](../../commit/c7dc6416), [`4e39c0c4`](../../commit/4e39c0c4) |

...
|------|-------------|---------------------|
| [Remove CLI, Promote Web UI to Binary](2026-07-01-remove-cli-promote-web.md) | Remove tama-cli, promote tama-web to the `tama` binary (zero-arg server, web UI only) | 🚧 IN PROGRESS |

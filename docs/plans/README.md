...
|------|-------------|---------------------|
| [MTP Draft Model File Support](2026-06-13-mtp-draft-model-files.md) | Add mtp-*.gguf draft model files as first-class auxiliary type — QuantKind::Mtp, pull wizard support, Spec Decoding dropdown, --mtp-model injection | 🚧 IN PROGRESS |

...
|------|-------------|---------------------|
| [Model Sort + Group](2026-07-02-model-sort-group.md) | Add sort and group controls to the dashboard Models section (GPU, Family, Vendor, Status) with localStorage persistence | #136, #137, #138, #139 ✅ COMPLETED |

...
|------|-------------|--------|
| [PATCH Endpoints](plan-155-patch-endpoints.md) | Add PATCH endpoints for models, config, and backends — truly surgical partial updates where only provided fields change | Ready |
